...
db_df = pd.read_sql("""
                    ...
                    """, con).set_index('zen_post_id')

results_df = pd.DataFrame(results)

from mydatabasemodule.praw_output_cleaner import clean_and_normalize

results_df.index.name = 'zen_post_id'
results_frames, _ = clean_and_normalize(results_df, 'posts')

cleaned_results_df = results_frames['posts']
